...
1. **EntryModelクラスへの移行**
   ...
   - [ ] 全ファイルでのインポート文の確認（EntryからEntryModelへ）
   - [ ] 型アノテーションの確認（EntryからEntryModelへ）
   - [x] テストコードの確認・修正
...
1. **項目3: エントリリストのScore列の機能拡張**
   - ✅ 基本的なScore列の表示とソート機能は実装済み
   - 評価スコアに基づく行の色分け表示機能を実装する
   - 実装対象ファイル：
