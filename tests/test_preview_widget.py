...
from sgpo_editor.gui.widgets.preview_widget import PreviewWidget, PreviewDialog
...
class TestPreviewWidget:
    ...
    def test_process_escape_sequences(self, preview_widget):
        ...
        assert preview_widget._process_escape_sequences("\\\\") == "\\"
        # 複合テスト
        assert preview_widget._process_escape_sequences("Test\\r\\nString") == "Test\r\nString"
...
class TestPreviewIntegration:
    ...
    def test_main_window_preview(self, monkeypatch, qtbot):
        ...
        monkeypatch.setattr('sgpo_editor.gui.widgets.preview_widget.PreviewDialog', mock_preview_dialog)
        # メインウィンドウが直接インポートするパスもモック化
        monkeypatch.setattr('sgpo_editor.gui.main_window.PreviewDialog', mock_preview_dialog)
