...
class TestColumnVisibility(unittest.TestCase):
    ...
    def test_main_window_toggle_column_visibility(self):
        ...
        # メソッドが正しく呼ばれたか確認
        main_window.table_manager.toggle_column_visibility.assert_called_once_with(
            column_index
        )
        main_window.ui_manager.update_column_visibility_action.assert_called_once_with(
            column_index, False
        )
